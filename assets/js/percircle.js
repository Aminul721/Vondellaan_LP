...
$.fn.percircle = function (options) {
  ...
  return this.each(function () {
    ...
    if (percent || localOptions.displayTextAtZero) {
      ...
      setTimeout(function () {
        $('.bar', percircle).css({
          '-webkit-transform': 'rotate(' + rotationDegrees * 40 + 'deg)',
          '-moz-transform': 'rotate(' + rotationDegrees * 40 + 'deg)',
          '-ms-transform': 'rotate(' + rotationDegrees * 40 + 'deg)',
          '-o-transform': 'rotate(' + rotationDegrees * 40 + 'deg)',
          'transform': 'rotate(' + rotationDegrees * 40 + 'deg)'
        });
      }, 0);
      ...
      setInterval(function () {
        ...
        var rotationDegrees = 3 * seconds; // temporary clockwise rotation value
        $('.bar', percircle).css({
          '-webkit-transform': 'rotate(' + rotationDegrees * 40 + 'deg)',
          '-moz-transform': 'rotate(' + rotationDegrees * 40 + 'deg)',
          '-ms-transform': 'rotate(' + rotationDegrees * 40 + 'deg)',
...
var getCountdown = function (percircle, options, progressBarStyle) {
  ...
  function timer() {
    ...
    if (secs > 2) percircle.addClass('gt50');
    if (secs < 2) percircle.removeClass('gt50');
  ...
  function timerUpdate() {
    ...
    var rotationDegrees = 3 * secs; // temporary clockwise rotation value
    $('.bar', percircle).css({
      '-webkit-transform': 'rotate(' + rotationDegrees * 40 + 'deg)',
      '-moz-transform': 'rotate(' + rotationDegrees * 40 + 'deg)',
      '-ms-transform': 'rotate(' + rotationDegrees * 40 + 'deg)',
